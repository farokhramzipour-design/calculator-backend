...
class Invoice(Base):
    ...
    buyer_eori: Mapped[str | None] = mapped_column(String(64))
    seller_eori: Mapped[str | None] = mapped_column(String(64))
...
class InvoiceItem(Base):
    ...
    vat_code: Mapped[str | None] = mapped_column(String(64))
    pack_count: Mapped[Decimal | None] = mapped_column(Numeric(18, 4))
    pack_type: Mapped[str | None] = mapped_column(String(64))
    net_weight: Mapped[Decimal | None] = mapped_column(Numeric(18, 4))
